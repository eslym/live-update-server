...
<script lang="ts">
    import { router, useForm, useRemember } from '@inertiajs/svelte';
...
<div class="accordion-group mt-4">
    <div class="accordion">
        <input type="radio" id="tab-info" value="info" bind:group={tab} class="accordion-toggle" />
        <label for="tab-info" class="accordion-title">Info</label>
        <div class="accordion-content">
            <div class="form-group max-w-[48rem] min-h-0">
                <div class="grid grid-cols-2 gap-2">
                    <div class="form-field">
                        <span class="form-label">ID</span>
                        <input
                            type="text"
                            value={project.nanoid}
    ...
    <div class="accordion">
        ...
        />
        <label for="tab-versions" class="accordion-title">Versions ({versions.total})</label>
        <div class="accordion-content overflow-hidden">
            <table class="table table-hover table-compact min-h-0">
                <thead>
                    <tr>
                        <th>Name</th>
