...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/engshun/projects/php/live-update-server/public/storage' => 'string',
            'google2fa.algorithm' => 'string',
            'google2fa.secret_length' => 'integer',
            'google2fa.window' => 'integer',
            'google2fa.keep_alive' => 'integer',
            'google2fa.renew_time_frame' => 'integer',
            'google2fa.debug' => 'boolean',
            'google2fa.enforce' => 'boolean',
            ...
            'tus.url' => 'NULL',
            'tus.path' => 'string',
            'tus.middleware' => 'array',
            'tus.storage_disk' => 'string',
            'tus.storage_path' => 'string',
            'tus.file_size_limit' => 'integer',
            'tus.upload_expiration' => 'integer',
            'tus.checksum_algorithm' => 'array',
            'tus.extensions' => 'array',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/engshun/projects/php/live-update-server/public/storage',
'google2fa.algorithm','google2fa.secret_length','google2fa.window','google2fa.keep_alive','google2fa.renew_time_frame',
'google2fa.debug','google2fa.enforce','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'session.secure','session.http_only','session.same_site','session.partitioned','tus.driver',
'tus.url','tus.path','tus.middleware','tus.storage_disk','tus.storage_path',
'tus.file_size_limit','tus.upload_expiration','tus.checksum_algorithm','tus.extensions','hashing.driver',
...
'debugbar.queries.explain','tus.options','tus.post','tus.head','tus.patch',
'tus.delete','sanctum.csrf-cookie','api.query','api.download','api.create','config.json','setup','login','password.reset',
'dashboard.index','project.index','project.create','project.view','project.update',
'project.delete','project.channel.create','project.channel.delete','project.version.index','project.version.create',
'project.version.update','project.version.delete','profile','profile.update','account.index',
'account.create','account.update','account.delete','token.index','token.create',
'token.delete','profile.2fa.setup','profile.2fa.verify','storage.local',);
...
'GOOGLE2FA_ENFORCE','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK',
