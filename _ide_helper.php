...
namespace KalynaSolutions\Tus\Facades {
    ...
    class Tus {
        ...
        public static function version()
        {
            /** @var \KalynaSolutions\Tus\Tus $instance */
            return $instance->version();
        }
         ...
         * @static 
         */
        public static function isValidChecksum($algo, $hash, $payload)
        {
            /** @var \KalynaSolutions\Tus\Tus $instance */
            return $instance->isValidChecksum($algo, $hash, $payload);
        }
         ...
         * @static 
         */
        public static function isUploadExpired($lastModified)
        {
            /** @var \KalynaSolutions\Tus\Tus $instance */
            return $instance->isUploadExpired($lastModified);
        }
         ...
         * @static 
         */
        public static function isInMaxFileSize($size)
        {
            /** @var \KalynaSolutions\Tus\Tus $instance */
            return $instance->isInMaxFileSize($size);
        }
         ...
         * @static 
         */
        public static function extensionIsActive($extension)
        {
            /** @var \KalynaSolutions\Tus\Tus $instance */
            return $instance->extensionIsActive($extension);
        }
         ...
         * @static 
         */
        public static function path($id, $extension = null)
        {
            /** @var \KalynaSolutions\Tus\Tus $instance */
            return $instance->path($id, $extension);
        }
...
namespace  {
    ...
    class Tus extends \KalynaSolutions\Tus\Facades\Tus {}
}
